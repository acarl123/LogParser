...
class MyFrame1 ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = wx.EmptyString, pos = wx.DefaultPosition, size = wx.Size( 500,392 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
		...
		self.canvas = FloatCanvas.FloatCanvas(self.m_panel1, Debug=0, BackgroundColor=(173, 173, 173))
		bSizer1.Add( self.canvas, 1, wx.ALL|wx.EXPAND, 5 )
