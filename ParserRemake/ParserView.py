...
class LogView ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.logFilePicker = wx.FilePickerCtrl( self.mainPanel, wx.ID_ANY, wx.EmptyString, u"Select a file", u"log files (*.txt, *.log)|*.txt; *.log", wx.DefaultPosition, wx.DefaultSize, wx.FLP_CHANGE_DIR|wx.FLP_DEFAULT_STYLE )
